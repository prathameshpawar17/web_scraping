...
- [LinkedIn](www.linkedin.com/in/prathamesh17)
...
1. **Clone the Repository**
   ...
   - Run the following command to clone the GitHub repository:
     ```
     git clone https://github.com/prathameshpawar17/web_scraping.git
     ```
...
Prathamesh Dnyaneshwar Pawar - [prathameshpawar1702@gmail.com](mailto:prathameshpawarpdp2002@gmail.com)
